...
<div>
    ...
    <div>
        ...
        <a href="/" style="color: #1a202c"> رجعوني الهوم بيج</a>
        <table>
            <tr>
                <th>الكوتش</th>
                <th>النوع</th>
                    ...
                    <td>
                        ...
                        @if($user->role_id==3)
                            <form action="/coaches/{{$user->id}}/promote" method="post">
                                ...
                                <button type="submit" style="color: green">خليه ل كوتش</button>
                            </form>
                        @else
                            <form action="/coaches/{{$user->id}}/demote" method="post">
                                @csrf
                                <button type="submit" style="color: red">رجعو عضو</button>
                            </form>
                        @endif
                    </td>
                </tr>
